"""
Unified metrics collector for all KV-cache experiments (Part 2).
Captures latency, throughput, memory, and efficiency metrics.

Shared verbatim in spirit with Part6-Inference-Parallelism/benchmarks/metrics_collector.py
so results are comparable across the series. Kept as a standalone copy here
so this Part's code folder is independently clonable/runnable.
"""
...
class ExperimentMetrics:
    ...
    extra: dict = field(default_factory=dict)   # free-form KV-cache-specific fields (memory curves, etc.)
